    ...
    <div className="relative h-[60vh] sm:h-[70vh] lg:h-[80vh] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Découvrez l'Ère des Dinosaures
          </motion.h2>
          ...
          >
            Des montagnes russes préhistoriques aux simulateurs immersifs, explorez un monde perdu 
            où chaque attraction vous transporte 65 millions d'années en arrière.
          </motion.p>
