    ...
    <div className="relative h-[60vh] sm:h-[70vh] lg:h-[80vh] w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div 
          ...
          style={{
            backgroundImage: `url('/dinooclock.jpg')`
                      }}
        />
      ...
      <div className="relative z-10 flex h-full items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            NOS
            <span className="bg-gradient-to-r from-amber-300 to-yellow-500 bg-clip-text text-transparent"> HORAIRES</span>
          </motion.h1>
          ...
          >
            Planifiez Votre Aventure Préhistorique
          </motion.h2>
          ...
          >
            Découvrez nos horaires d'ouverture, les heures de spectacles et les moments optimaux 
            pour explorer notre parc à thème dinosaure en toute tranquillité.
          </motion.p>
...
export default HorairesHeroSection;